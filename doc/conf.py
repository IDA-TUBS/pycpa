# -*- coding: utf-8 -*-
#
# pycpa documentation build configuration file, created by
...
project = u'pyCPA'
copyright = u'2012, Jonas Diemer, Philip Axer'
...
latex_documents = [
  ('index', 'pycpa.tex', u'pycpa Documentation',
   u'Diemer, Axer', 'manual'),
]
